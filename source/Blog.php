...
<div class="header">
  <h2 style="color:#ff3256">Lady-Hub Blogs</h2>
</div>
...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      ...
      <div>
        <img src="./shopping/img/anxietystory.png" alt="image4" class="img-fluid card-img-top">
      </div>
      </div>
    ...
    <div class="card">
      ...
      <div class="card shadow" style="height:300px;">
      <div>
        <img src="./shopping/img/bodysize.png" alt="image4" class="img-fluid card-img-top">
       </div>
      </div>
      <p>Some text..</p>
      <p>Sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
  ...
  <div class="rightcolumn">
    <div class="card">
      ...
      <div>
        <img src="./shopping/img/aboutme.png" alt="image4" class="img-fluid card-img-top">
      </div>
      </div>
    ...
    <div class="card">
      <h3>Follow Us</h3>
      <p>Ig - <a href="">@ladyhub</a></p>
	  <p>Tw - <a href="">@lady_hub</a></p>
    </div>
  </div>
</div>
